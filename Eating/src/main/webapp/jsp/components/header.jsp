  ...
  <body>
    <header id="header">
      ...
      <div class="inner">
        ...
        <div class="toparea">
          <h1>
            <a href="/front/dp/dpa/dawnHome.do" onclick="GA_Event('PC_공통', '로고', '현대식품관투홈');"><img src="/src/main/webapp/images/common/header_logo_freex34.png" alt="현대식품관" /></a>
          </h1>
          <!-- util : 로그인 전// -->
          <!-- //util : 로그인 전 -->
          <!-- util : 로그인 후// -->
        ...
        <nav class="gnbarea">
                ...
                <ul class="lnb">
                  ...
                  <li class="exhibition-wrap">
                    ...
                    <ul class="exhibition-list">
                      <li>
                        <a href="/front/dp/dpc/spexSectDetailMain.do?sectId=901735&amp;ga_param=daily" onclick="GA_Event('PC_공통', '큐레이션H', '명인명촌');"> <img src="https://tohomeimage.thehyundai.com/DP/DP036/2021/01/15/162216/20210111_curationH_category_MIMC.jpg" alt="" onerror="this.src='/UIUX/m/pjtCom/images/common/noimage_350x420.jpg'" /> <strong class="txt">명인명촌</strong> </a>
                      </li>
                      <li>
                        <a href="/front/dp/dpc/spexSectDetailMain.do?sectId=901743&amp;ga_param=daily" onclick="GA_Event('PC_공통', '큐레이션H', '원테이블');"> <img src="https://tohomeimage.thehyundai.com/DP/DP036/2020/12/15/172621/curationH_1table.jpg" alt="" onerror="this.src='/UIUX/m/pjtCom/images/common/noimage_350x420.jpg'" /> <strong class="txt">원테이블</strong> </a>
                      </li>
                      <li>
                        <a href="/front/dp/dpc/spexSectDetailMain.do?sectId=901748&amp;ga_param=daily" onclick="GA_Event('PC_공통', '큐레이션H', '그리팅');"> <img src="https://tohomeimage.thehyundai.com/DP/DP036/2021/01/15/162216/20210111_curationH_category_greating.jpg" alt="" onerror="this.src='/UIUX/m/pjtCom/images/common/noimage_350x420.jpg'" /> <strong class="txt">그리팅</strong> </a>
                      </li>
                      <li>
                        <a href="/front/dp/dpc/spexSectDetailMain.do?sectId=901800&amp;ga_param=daily" onclick="GA_Event('PC_공통', '큐레이션H', '예향');"> <img src="https://tohomeimage.thehyundai.com/DP/DP036/2021/12/30/160313/20211230142827702.1926818.jpg" alt="" onerror="this.src='/UIUX/m/pjtCom/images/common/noimage_350x420.jpg'" /> <strong class="txt">예향</strong> </a>
                      </li>
                      <li>
                        <a href="/front/dp/dpc/spexSectDetailMain.do?sectId=901757&amp;ga_param=daily" onclick="GA_Event('PC_공통', '큐레이션H', '동행마켓');"> <img src="https://tohomeimage.thehyundai.com/DP/DP036/2021/12/23/151317/20211221_brand_thumb_donghaeng.jpg" alt="" onerror="this.src='/UIUX/m/pjtCom/images/common/noimage_350x420.jpg'" /> <strong class="txt">동행마켓</strong> </a>
                      </li>
                      <li>
                        <a href="https://tohome.thehyundai.com/front/dp/dpi/prmsBoxList.do?ga_param=daily" onclick="GA_Event('PC_공통', '큐레이션H', '투홈구독');"> <img src="https://tohomeimage.thehyundai.com/DP/DP036/2021/06/08/180241/20210608175940774.1926818.jpg" alt="" onerror="this.src='/UIUX/m/pjtCom/images/common/noimage_350x420.jpg'" /> <strong class="txt">투홈구독</strong> </a>
                      </li>
                    </ul>
                  </li>
                </ul>
          ...
          <ul class="gnb-list" id="homeGnbList">
            <li><a href="/jsp/main/diff.jsp">차별점</a></li>
            <li><a href="/jsp/main/sale.jsp">세일</a></li>
            <li><a href="../main/new.jsp">신상품</a></li>
          </ul>
          <!-- //gnb -->
          <!-- search// -->
          ...
          <!-- //search -->
          <button type="button" class="btn-cart" onclick="GA_Event('PC_공통', '헤더', '장바구니'); javascript:fnPdShippingBasketList( this);">장바구니<span id="basketCnt">0</span></button>
        </nav>
        <!-- //gnbarea -->
      </div>
    </header>
