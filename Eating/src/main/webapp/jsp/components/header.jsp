...
<body>
	<header id="header">
		...
		<div class="inner">
			...
			<div class="toparea">
				<h1>
					<a href="/front/dp/dpa/dawnHome.do" onclick="GA_Event('PC_공통', '로고', '현대식품관투홈');"><img src="images/common/header_logo_freex34.png" alt="현대식품관" /></a>
				</h1>
				<!-- util : 로그인 전// -->
				<!-- //util : 로그인 전 -->
				<!-- util : 로그인 후// -->
			...
			<nav class="gnbarea">
				...
				<ul class="gnb-list" id="homeGnbList">
					...
					<li><a href="jsp/main/diff.jsp">세일</a></li>
					<li><a href="jsp/main/diff.jsp">신상품</a></li>
				</ul>
				<!-- //gnb -->
				<!-- search// -->
