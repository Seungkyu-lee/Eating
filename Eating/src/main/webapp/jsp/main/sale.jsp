<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8"%> <%@ include file="/jsp/components/header.jsp"%>
<div id="contents">
  <div class="innercon">
    <h2>세일</h2>
    <!-- filter// -->
        ...
        <div class="form-filter">
          <ul class="btn-group" id="sortType">
            <li>
              ...
              <button type="button" class="active" onclick="GA_Event('PC_세일','정렬방식','정렬_추천순'); fnSortType('F');">추천순</button>
              <!-- 활성화 : class="active" 추가 -->
            </li>
    ...
    <ul class="product-list" id="ulItemList">
      <%--
      <c:forEach items="${productsItemList}" var="orderVO"> <%@ include file="../components/productItemBox.jsp"%> </c:forEach>
      --%> <%@ include file="../components/productItemBox.jsp"%> <%@ include file="../components/productItemBox.jsp"%> <%@ include file="../components/productItemBox.jsp"%> <%@ include file="../components/productItemBox.jsp"%> <%@ include file="../components/productItemBox.jsp"%> <%@ include file="../components/productItemBox.jsp"%> <%@ include file="../components/productItemBox.jsp"%> <%@ include file="../components/productItemBox.jsp"%> <%@ include file="../components/productItemBox.jsp"%> <%@
      include file="../components/productItemBox.jsp"%> <%@ include file="../components/productItemBox.jsp"%> <%@ include file="../components/productItemBox.jsp"%>
    </ul>
    <!-- //list -->
  </div>
</div>
